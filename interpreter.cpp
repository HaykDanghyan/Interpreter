      ...
      if ( str.substr ( 0 , 3 ) == "var" ){
        ...
        if ( str.substr ( 0 , 3 ) == "str" ){
          ...
          incrementStr++;
            ...
            algs[incrementAlg] = alg_definition(str);
            incrementAlg++;
        }
        else if( str.substr (0,3) == "out"){
            data_output(str, numbers , strs, algs);
        }  
        else if( str.substr(0,3) == "chc" ){
        ...
        if ( str.substr(0,3) != "out" &&  str.substr(0 , 3) != "var" && str.substr(0 , 3) != "str" &&  str.substr(0 , 2) != "chc" && str.substr(0,3) != "rep" && str.substr( 0 , 3 ) != "alg" ){
